...
module.exports = class Game {
  constructor(ctx) {
    ...
    // this.blocks2 = [
    //   new Block(650, 392.5, 20, 20, 'red', 'black'),
    //   new Block(450, 392.5, 20, 20, 'red', 'black'),
    //   new Block(250, 392.5, 20, 20, 'red', 'black'),
    //   // new Block(650, 420, 20, 20, 'red', 'black'),
    // ];

    this.badGuys1 = [
      new Block(630, 345.5, 20, 20, 'orange', 'black'),
      new Block(730, 345.5, 20, 20, 'orange', 'black'),
      new Block(830, 345.5, 20, 20, 'orange', 'black'),
    ];
